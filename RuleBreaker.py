...
window.wm_title("Automatic Event Detection from Traffic Surveillance Video")
...
lbl1.pack(side='top')
tk.Button(frame,text='Billing',command=billingmode).pack(side='left')
...
display3 = tk.Label(frame3,text="Developed by \n CPG 05",font = "verdana 14 bold",fg='violet')
...
cap=cv2.VideoCapture('Videos/s3.avi')
